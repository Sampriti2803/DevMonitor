...
function getCategoryBadgeClass(category: string): string {
  ...
  if (c.includes("research") || c.includes("publication")) return "badge badge-purple";
  if (c.includes("product") || c.includes("model")) return "badge badge-green";
  if (c.includes("company") || c.includes("announcement")) return "badge badge-blue";
  if (c.includes("safety") || c.includes("security")) return "badge badge-red";
  if (c.includes("chatgpt") || c.includes("feature")) return "badge badge-cyan";
  return "badge badge-amber";
}

export default function ChatGPTReleases() {
