...
function getCategoryBadgeClass(category: string): string {
  ...
  if (c.includes("research") || c.includes("science")) return "badge badge-purple";
  if (c.includes("product") || c.includes("model")) return "badge badge-blue";
  if (c.includes("ai") || c.includes("gemini")) return "badge badge-cyan";
  return "badge badge-blue";
}

export default function GeminiReleases() {
